...
function Longitud () {
    ...
    const [desde, setDesde] = useState(convert().list("length")[0].abbr);
    const [hasta, setHasta] = useState(convert().list("length")[1].abbr);
        ...
        <div className="marcoPrincipal">
            ...
            <div className="select">
                ...
                <select className="select" value={desde} onChange={(e) => setDesde(e.target.value)}>
                    {convert().list("length").map((option, i) => (
