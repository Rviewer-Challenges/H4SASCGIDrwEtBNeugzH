...
function Volumen () {
    ...
    const [desde, setDesde] = useState(convert().list("volume")[0].abbr);
    const [hasta, setHasta] = useState(convert().list("volume")[1].abbr);
        ...
        <div className="marcoPrincipal">
            ...
            <div className="select">
                ...
                <select className="select" value={desde} onChange={(e) => setDesde(e.target.value)}>
                    {convert().list("volume").map((option, i) => (
